...
void store_two_bytes(sixteen_bits);
void push_level(name_pointer);
void pop_level(int);
void get_output(void);
void flush_buffer(void);
eight_bits skip_ahead(void);
int skip_comment(boolean);
eight_bits get_next(void);
void scan_repl(eight_bits);
